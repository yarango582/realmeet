  ...
  return (
    <div className="bg-white">
      <Container>
        ...
        <FeaturesHeader text="End to end encryption" />
        <FeaturesContent>
          <>
            Unlike most video call applications, all video data in Realmeet is
        ...
        <FeaturesContent>
          <>
            The only server calls Realmeet makes are to a signalling server that
            helps you find and connect to peers. Room names, participant names
            and, most importantly. video data are never sent to a server.
          </>
        </FeaturesContent>
      </Container>
    </div>
